...
const { getEvents,getEvent, createEvent, eventsByGroup, eventById, isCreator, deleteEvent, updateEvent, attendEvent,notAttendEventGroup } = require('../controllers/event');
